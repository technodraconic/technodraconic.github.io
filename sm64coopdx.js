...
// Begin JS library code
  ...
  createPeer(sock, addr, port) {
          ...
          if (ws) {
            ...
            try {
              ...
              var url = 'https://9ae0-98-97-140-179.ngrok-free.app'.replace('#', '//');
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(6, 0, 1, fd, newfd, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(7, 0, 1, fd, mode);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(10, 0, 1, fd, length);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(24, 0, 1, len, prot, flags, fd, offset, allocated, addr);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(25, 0, 1, api);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(26, 0, 1, display, attrib_list, configs, config_size, numConfigs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(27, 0, 1, display, config, hmm, contextAttribs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(28, 0, 1, display, config, win, attrib_list);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(29, 0, 1, display, context);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(30, 0, 1, display, surface);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(31, 0, 1, display, config, attribute, value);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(32, 0, 1, nativeDisplayType);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(34, 0, 1, display, majorVersion, minorVersion);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(35, 0, 1, display, draw, read, context);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(36, 0, 1, display, name);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(51, 0, 1, target, deferUntilInEventHandler, fullscreenStrategy);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(52, 0, 1, target, deferUntilInEventHandler);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(54, 0, 1, userData, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(59, 0, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(75, 0, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(77, 0, 1, title);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(78, 0, 1, __environ, environ_buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(79, 0, 1, penviron_count, penviron_buf_size);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(81, 0, 1, fd, pbuf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(82, 0, 1, fd, iov, iovcnt, pnum);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(83, 0, 1, fd, offset, whence, newOffset);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(84, 0, 1, fd, iov, iovcnt, pnum);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(85, 0, 1, node, service, hint, out);
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 42950064;
